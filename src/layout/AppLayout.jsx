  ...
  return (
    <div className="wrapper">
      ...
      <Block
        id={'about'}
        title={{
          first: t('about.title.first'),
          second: t('about.title.second'),
        }}
      ...
      <Block
        id={'reference'}
        title={{
          first: t('reference.title.first'),
          second: t('reference.title.second'),
        }}
      ...
      >
        <div className="about-text">
          ...
          <p>{t('reference.text-quote')}</p>
          <img src={quoteText} alt="qutoe" />
        </div>
        <Button
          link={'https://t.me/akronix_bot'}
          text={t('reference.button')}
        />
      </Block>
      <Reference />
      <Akron />
      <Block
        title={{
          first: t('token.title.first'),
          second: t('token.title.second'),
        }}
        text={t('token.text')}
