...
export function PartnerTab() {
  ...
  return (
    <div className={styles.partner}>
      <p className={'form-text'}>{t('tokenomic.form.tabs.2.paragraph')}</p>
      ...
      <ul className={'list'}>
        <li>
          <div>
            <span>{t('tokenomic.form.tabs.2.list.0.type')}</span>
            <span>{userInfo.refs_count}</span>
          </div>
        </li>
        <li>
          <div>
            <span>{t('tokenomic.form.tabs.2.list.1.type')}</span>
