...
import { calculateTimeLeft } from "../../utils.js";
  ...
  return (
    <div className={styles.timer}>
      <div className={styles.item}>
        <span className={styles.time}>{ t('tokenomic.timer.days') }</span>
        <div className={styles.value}>{ timeLeft.days }</div>
      </div>
      <span className={styles.colon}>:</span>
      <div className={styles.item}>
        <span className={styles.time}>{ t('tokenomic.timer.hours') }</span>
        <div className={styles.value}>{ timeLeft.hours }</div>
      </div>
      <span className={styles.colon}>:</span>
      <div className={styles.item}>
        <span className={styles.time}>{ t('tokenomic.timer.minutes') }</span>
        <div className={styles.value}>{ timeLeft.minutes }</div>
      </div>
      <span className={`${styles.colon} ${styles.colonSeconds}`}>:</span>
      <div className={styles.item}>
        <span className={styles.time}>{ t('tokenomic.timer.seconds') }</span>
