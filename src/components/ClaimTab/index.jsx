...
export function ClaimTab() {
  ...
  return (
    <div className={styles.claim}>
      <p className={'form-text'}>{t('tokenomic.form.tabs.1.paragraph')}</p>
      <h3>{userInfo.user_info.akron} akron</h3>
      <ul className={'list'}>
        <li>
          <div>
            <span>{t('tokenomic.form.tabs.1.list.0.type')}</span>
            <span>{userInfo.claim_info.next_unlock_value}</span>
          </div>
        </li>
        <li>
          <div>
            <span>{t('tokenomic.form.tabs.1.list.1.type')}</span>
            <span>
        ...
        <li>
          <div>
            <span>{t('tokenomic.form.tabs.1.list.2.type')}</span>
            <span>{userInfo.claim_info.monthly_value} AKRON</span>
          </div>
        </li>
        <li>
          <div>
            <span>{t('tokenomic.form.tabs.1.list.3.type')}</span>
